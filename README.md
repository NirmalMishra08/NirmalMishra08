...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/nirmal_mishra24/)
...
![Profile Views](https://komarev.com/ghpvc/?username=NirmalMishra08&color=blueviolet&style=for-the-badge)
...
const nirmal = {
    ...
    funFact: "I can debug code faster than I can decide what to eat for dinner! 🍕"
};
```
...
### 📚 [BookNook](https://github.com/NirmalMishra08/bookNook) - E-commerce Platform
**Full-featured book & course marketplace with payment integration**
...
```
✨ Features: JWT Auth • Shopping Cart • Stripe Payments • Redis Caching • Admin Dashboard
```

[![Repository](https://img.shields.io/badge/View_Code-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/NirmalMishra08/bookNook)

---

### 💬 [Mingle](https://github.com/NirmalMishra08/Mingle) - Real-time Social Platform
**Social media with instant messaging, posts & live notifications**
...
```
✨ Features: Real-time Chat • Post Feed • Notifications • User Profiles • WebSocket Communication
```

[![Repository](https://img.shields.io/badge/View_Code-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/NirmalMishra08/Mingle)

---

### 🎓 [ClassMate](https://github.com/NirmalMishra08/classMate) - Academic Management System
**Comprehensive attendance tracking with analytics dashboard**
...
```
✨ Features: Attendance Tracking • Analytics Dashboard • Reports • Student Management
```

[![Repository](https://img.shields.io/badge/View_Code-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/NirmalMishra08/classMate)

---

### 💭 [Chat App Example](https://github.com/NirmalMishra08/chat-app-example) - WebSocket Chat
**Room-based real-time chat with message persistence**
...
```
✨ Features: Room-based Chat • Real-time Messages • Message History • User Presence
```

[![Repository](https://img.shields.io/badge/View_Code-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/NirmalMishra08/chat-app-example)
...
| **Go Development** | 📚 Learning | High-concurrency applications with Gin & Fiber |
| **Kubernetes & Docker** | 🔧 Practicing | Container orchestration and deployment |
| **System Design** | 💪 Mastering | Designing systems that handle millions of requests |
| **Real-time Systems** | ⚡ Building | WebSocket & Socket.IO implementations |
...
[![Instagram](https://img.shields.io/badge/Instagram-Follow-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/nirmal_mishra24/)
...
📧 **Email:** nirmalmishra.dev@gmail.com
